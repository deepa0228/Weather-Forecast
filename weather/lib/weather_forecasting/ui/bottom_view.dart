...
// Alternative method of coding(Better Method)

class BottomView extends StatelessWidget {
  final AsyncSnapshot<WeatherForecastModel> snapshot;
  

  const BottomView({Key key, this.snapshot}) : super(key: key);@override
     ...
     children: [
       ...
       Container(
         ...
         child: ListView.separated(
           scrollDirection: Axis.horizontal, //if its not specified then its vertical by default
